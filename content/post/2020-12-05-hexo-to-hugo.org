...
由于目前我全局开启了 evil mode，需要把 easy-hugo-mode 添加到 evil-emacs-state-modes 里面去才能使用 easy-hugo 的快捷键，顺道解决了 [[https://github.com/masasam/emacs-easy-hugo/pull/56][easy hugo 的一个 bug]]。完整配置可参考[[https://github.com/jiacai2050/dotfiles/commit/5cefaa5f8f8400569e2d79b81605aee4180bf997][这次 Git 提交]]。
